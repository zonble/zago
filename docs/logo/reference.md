...
| `FORMAT.NAME` | `FORMATNAME` | `FORMAT.NAME given [middle] family [style] [locale]` or `FORMAT.NAME [propList]` | Formats person name components (given, middle, family, prefix, suffix, nickname) according to localized cultural conventions | `FORMAT.NAME "Arthur "Conan "Doyle "long`, `FORMAT.NAME "Steve "Jobs "abbreviated` |
