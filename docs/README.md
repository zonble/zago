...
- [Mark and selection development plan](mark_development_plan.md): implementation phases and test coverage for the mark model.
- [Command bar dispatch plan](command_bar_dispatch_plan.md): planned split between editor shorthand commands and LOGO syntax.
