...
@Test func testCJKWordNavigation() {
    ...
    // Move forward stops after 好 (2..<3)
    buffer.moveWordForward()
    #expect(buffer.columnIndex == 3)  // after 好

    // Move forward stops after the word 世界 (3..<5)
    buffer.moveWordForward()
    #expect(buffer.columnIndex == 5)  // after 世界

    // Move backward moves before 世界
    buffer.moveWordBackward()
    #expect(buffer.columnIndex == 3)  // before 世界

    // Move backward moves before 好
    buffer.moveWordBackward()
