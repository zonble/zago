...
@Suite struct CoverageBoostTests {
    ...
    @Test func testArrowStyleParsingAndMethods() {
        ...
        #expect(ArrowStyle("diamond") == .diamond)
        #expect(ArrowStyle("solid-diamond") == .solidDiamond)
        #expect(ArrowStyle("circle") == .circle)
        #expect(ArrowStyle("open-circle") == .openCircle)
        #expect(ArrowStyle("cross") == .cross)
        #expect(ArrowStyle("crow") == .crow)
        #expect(ArrowStyle("harpoon") == .harpoon)
        ...
        #expect(ArrowStyle.from("diamond") == .diamond)
        #expect(ArrowStyle.from("circle") == .circle)
        ...
        #expect(ArrowStyle.isStyleToken("diamond") == true)
        #expect(ArrowStyle.isStyleToken("cross") == true)
