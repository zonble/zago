...
export const zhTW: TranslationSchema = {
  ...
  btnPlayTMD: "試聽樂譜",
  synthSelectLabel: "MIDI 音色",
  synthSelectTitle: "切換 SoundFont 音色 / 合成器",
  synthOptionPiano: "🎹 平台鋼琴 (FluidR3 高音質)",
  synthOptionTiny: "⚡ 極簡合成器 (Tiny Synth)",
  synthOptionWebMidi: "🎛 系統原生 MIDI 輸出",
  btnImport: "匯入",
  btnExportZip: "匯出 ZIP",
  btnResetVFS: "重設工作區",
  btnHelp: "說明",
  btnCollapseSidebar: "收起說明",
  btnExpandSidebar: "展開說明",
  btnToggleSidebar: "切換說明欄",
