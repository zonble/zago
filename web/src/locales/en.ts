export const en = {
  ...
  synthSelectLabel: "MIDI Synth",
  synthSelectTitle: "Change SoundFont / Synthesizer",
  ...
  btnHelp: "Help",
  btnCollapseSidebar: "Collapse Sidebar",
  btnExpandSidebar: "Show Sidebar",
  btnToggleSidebar: "Toggle Sidebar",
