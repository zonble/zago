...
extension Key {
    ...
    public var helpBarLabel: String {
        ...
        case .shiftArrowLeft, .shiftArrowRight, .shiftArrowUp, .shiftArrowDown: return "⇧+←/→/↑/↓"
        case .ctrlArrowLeft, .ctrlArrowRight, .ctrlArrowUp, .ctrlArrowDown: return "^+←/→/↑/↓"
        case .ctrlShiftArrowLeft, .ctrlShiftArrowRight: return "^⇧ ←/→"
        case .ctrlShiftArrowUp, .ctrlShiftArrowDown: return "^⇧ ↑/↓"
        case .altArrowLeft, .altArrowRight, .altArrowUp, .altArrowDown: return "⌥+←/→/↑/↓"
        ...
        case .tab: return "Tab"
        case .altTab: return "⌥Tab"
        case .backtab: return "⇧Tab"
        case .enter: return "⏎"
        case .altEnter: return "⌥⏎"
        case .esc: return "⎋"
        case .backspace: return "BS"
        case .ctrlBackspace: return "^⌫"
        case .altBackspace: return "⌥⌫"
