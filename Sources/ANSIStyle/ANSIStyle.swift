...
public enum ANSIStyle {
    ...
    /// AI Ghost proposal inverse highlight text attribute: Bold Black text on Cyan background (`\u{1B}[46;30;1m`) for 100% legibility.
    public static let aiGhostOverlay = "\u{1B}[46;30;1m"
