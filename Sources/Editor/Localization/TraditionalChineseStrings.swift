...
public struct TraditionalChineseStrings {
    public static let table: [String: String] = [
        ...
        "help.keys.search_classic": "^W / F6, M+N/P",
        "help.keys.search_modern": "^F / F3, M+N/P",
        "help.keys.document_outline": "M+[ / M+] / M+\\",
        "help.keys.menu_show": "F1 / M+M / ^M",
        "help.keys.selection_extend": "⇧+方向鍵/Home/End",
        "help.keys.canvas_draw_line": "⇧+方向鍵",
        "help.keys.canvas_draw_arrow": "^⇧+方向鍵/^+方向鍵",
        "help.keys.canvas_block_mark": "^^ / M+B",
        "help.keys.canvas_block_mark_canvas": "^^ / M+B (Canvas)",

        "help.keys.nav_right_classic": "^F / 右方向鍵",
        "help.keys.nav_left_classic": "^B / 左方向鍵",
        "help.keys.nav_up_classic": "^P / 上方向鍵",
        "help.keys.nav_down_classic": "^N / 下方向鍵",
        "help.keys.nav_home_classic": "^A / Home",
        "help.keys.nav_end_classic": "^E / End",
        "help.keys.nav_pgdn_classic": "^V / 下頁",
        "help.keys.nav_pgup_classic": "^Y / 上頁",
        "help.keys.delete_classic": "^D / Delete",
        "help.keys.cut_classic": "^K / F9",
        "help.keys.cut_modern": "^X / F9",
        "help.keys.uncut_classic": "^U / F10",
        "help.keys.uncut_modern": "^V / F10",
        "help.keys.tab_classic": "^I / Tab",
        "help.keys.exit_classic": "^X / F2",
        "help.keys.cursor_pos_classic": "^C / F11",
        "help.keys.cursor_pos_modern": "F11 / M+C",
        "help.keys.spell_classic": "^T / F12",
        "help.keys.write_out_classic": "^O / F3",
        "help.keys.insert_file_classic": "^R / F5",
