...
struct TraditionalChineseStrings {
    static let table: [String: String] = [
        ...
        "describe_command.prompt_input": "請輸入指令名稱、自訂 Procedure 或 Primitive：",
        "describe_command.footer_input": "[ Enter: 查詢  |  Esc: 關閉 ]",
        ...
        "describe_command.user_procedure": "自訂程序 (LOGO Procedure)",
        "describe_command.syntax": "語法：",
        "describe_command.no_parameters": "(無參數)",
        "describe_command.docstring": "說明文件 (Docstring)",
        "describe_command.no_docstring": "(未提供 docstring)",
        "describe_command.definition": "定義 (Definition)",
        "describe_command.editor_command": "編輯器指令 (Editor Command)",
