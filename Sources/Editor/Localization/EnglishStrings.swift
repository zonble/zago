...
public struct EnglishStrings {
    public static let table: [String: String] = [
        ...
        "help.keys.selection_extend": "⇧+Arrow/Home/End",
        "help.keys.canvas_draw_line": "⇧+Arrow",
        "help.keys.canvas_draw_arrow": "^⇧+Arrow / ^+Arrow",
        "help.keys.canvas_block_mark": "^^ / M+B",
        "help.keys.canvas_block_mark_canvas": "^^ / M+B (Canvas)",

        "help.keys.nav_right_classic": "^F / Right Arrow",
        "help.keys.nav_left_classic": "^B / Left Arrow",
        "help.keys.nav_up_classic": "^P / Up Arrow",
        "help.keys.nav_down_classic": "^N / Down Arrow",
        "help.keys.nav_home_classic": "^A / Home",
        "help.keys.nav_end_classic": "^E / End",
        "help.keys.nav_pgdn_classic": "^V / PgDn",
        "help.keys.nav_pgup_classic": "^Y / PgUp",
