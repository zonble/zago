        ...
        var baseCategories: [MenuCategory] = [
            ...
            MenuCategory(
                ...
                items: [
                    ...
                    arrowStyleItem(.dotted, titleKey: "menu.arrows.dotted", hotkeyChar: "7"),
                    arrowStyleItem(.harpoon, titleKey: "menu.arrows.harpoon", hotkeyChar: "8"),
                    arrowStyleItem(.crow, titleKey: "menu.arrows.crow", hotkeyChar: "9"),
                    .divider,
                    arrowStyleItem(.solidDiamond, titleKey: "menu.arrows.solid_diamond", hotkeyChar: "s"),
                    arrowStyleItem(.diamond, titleKey: "menu.arrows.diamond", hotkeyChar: "d"),
                    arrowStyleItem(.circle, titleKey: "menu.arrows.circle", hotkeyChar: "c"),
                    arrowStyleItem(.openCircle, titleKey: "menu.arrows.open_circle", hotkeyChar: "o"),
