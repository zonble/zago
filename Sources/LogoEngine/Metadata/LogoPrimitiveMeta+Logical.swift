    ...
    var logicalMeta: LogoPrimitiveMeta? {
            ...
            LogoPrimitiveMeta(
                ...
                parameters: [
                    LogoPrimitiveParameter(
                        name: "cond1", required: true, description: "The cond1 argument. Used by ANDLOGIC.",
                        example: "value"),
                    LogoPrimitiveParameter(
                        name: "cond2", required: true, description: "The cond2 argument. Used by ANDLOGIC.",
                        example: "value"),
                    LogoPrimitiveParameter(
                        name: "...", required: false, description: "The ... argument. Used by ANDLOGIC.", example: "..."
                    ),
                ],
        ...
        case .orLogic:
            LogoPrimitiveMeta(
                ...
                parameters: [
                    LogoPrimitiveParameter(
                        name: "cond1", required: true, description: "The cond1 argument. Used by ORLOGIC.",
                        example: "value"),
                    LogoPrimitiveParameter(
                        name: "cond2", required: true, description: "The cond2 argument. Used by ORLOGIC.",
                        example: "value"),
                    LogoPrimitiveParameter(
                        name: "...", required: false, description: "The ... argument. Used by ORLOGIC.", example: "..."),
                ],
        ...
        case .xorLogic:
            LogoPrimitiveMeta(
                ...
                parameters: [
                    LogoPrimitiveParameter(
                        name: "a", required: true, description: "The a argument. Used by XORLOGIC.", example: "1"),
                    LogoPrimitiveParameter(
                        name: "b", required: true, description: "The b argument. Used by XORLOGIC.", example: "1"),
                ],
        ...
        case .notLogic:
            LogoPrimitiveMeta(
                ...
                parameters: [
                    LogoPrimitiveParameter(
                        name: "condition", required: true, description: "The condition to evaluate. Used by NOTLOGIC.",
                        example: "1")
                ],
